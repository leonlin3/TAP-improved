...
def param_init_gru_cond(options, params, prefix='gru_cond',
    ...
    #LN scale and shift
    #gru1
    params['gain5'] = numpy.ones((dim*2,), dtype='float32')
    params['bias5'] = numpy.zeros((dim*2,), dtype='float32')
    params['gain6'] = numpy.ones((dim*2,), dtype='float32')
    params['bias6'] = numpy.zeros((dim*2,), dtype='float32')
    params['gain7'] = numpy.ones((dim,), dtype='float32')
    params['bias7'] = numpy.zeros((dim,), dtype='float32')
    params['gain8'] = numpy.ones((dim,), dtype='float32')
    params['bias8'] = numpy.zeros((dim,), dtype='float32')

    #gru2
    params['gain9'] = numpy.ones((dim*2,), dtype='float32')
    params['bias9'] = numpy.zeros((dim*2,), dtype='float32')
    params['gain10'] = numpy.ones((dim*2,), dtype='float32')
    params['bias10'] = numpy.zeros((dim*2,), dtype='float32')
    params['gain11'] = numpy.ones((dim,), dtype='float32')
    params['bias11'] = numpy.zeros((dim,), dtype='float32')
    params['gain12'] = numpy.ones((dim,), dtype='float32')
    params['bias12'] = numpy.zeros((dim,), dtype='float32')
